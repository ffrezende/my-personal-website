  ...
  render() {
    return (
      <div className='section section-typo'>
        ...
        <img alt='...' className='path path1' src={require('assets/img/path3.png')} />
        <Container>
          ...
          <div id='typography'>
            <Row>
              <Col md='12'>
                ...
                <div className='typography-line'>
                  <p>
                    <span>Paragraph</span>I will be the leader of a company that ends up being worth
                    billions of dollars, because I got the answers. I understand culture. I am the
                    nucleus. I think that’s a responsibility that I have, to push possibilities, to
                ...
                <div className='typography-line'>
                  ...
                  <blockquote>
                    <p className='blockquote blockquote-info'>
                      ...
                      dollars, because I got the answers. I understand culture. I am the nucleus. I
